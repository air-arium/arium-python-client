...
)  # Used to create output folder # datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
output_folder = OUTPUT_FOLDER.format(calc_id=calc_id)

# CONFIGURATION MAP
filepath = "data/" + test_name + ".csv"
filepath_template = "data/template_testS_updated.csv"
config_replace = {
    # "TriggerType": "path",
    "CoverageType": "data/CoverageTypeConfig.csv",
    # "Country": "path",
    # "State": "path",
}
date_format = "%d/%m/%Y"
