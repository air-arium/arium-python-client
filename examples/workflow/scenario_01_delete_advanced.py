...
s_2021_Q3_folder = [scenario['id'] for scenario in scenarios if is_scenario_in_folder(scenario['name'], "2021 Q3")]
...
s_Air = [scenario['id'] for scenario in scenarios if "Air" in scenario['name']
         and is_scenario_in_folder(scenario['name'], "test")]
