...
ENDPOINT_RAW_CLAIMS = "calculations/{calculations_id}/raw_claims"
ENDPOINT_PROCESSED_CLAIMS = "calculations/{{calculations_id}}/processed_claims/{level}"
ENDPOINT_LOGS = "calculations/{{calculations_id}}/logs/{level}"
ENDPOINT_GRAPH = "calculations/{calculations_id}/graph"
PORT = "port"

AUTH_SERVER = "auth_server"
ISSUER = "issuer"
AUDIENCE = "audience"
AUDIENCE_PDCA = "pdca_env"
CLIENT_ID = "client_id"
