...
class Asset:
    ...
    def __init__(
        self, asset: Union[list, dict, str] = None, asset_type: str = None
    ) -> None:
        self._asset = asset
...
class LossAllocationRequest:
    ...
    def set_total_loss(self, on=False):
        self.total_loss = bool(on)
    ...
    def add_csv_export(
        self, export_type: str, characteristics: List[str], metrics: List[str]
    ):
